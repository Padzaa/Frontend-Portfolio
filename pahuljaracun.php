...
-->
        ...
        <div class="row">
          <div  class="col-sm"><spline> Račun za mjesec: <?php echo date("m/Y"); ?></spline></div>
          <div id=impd class="col-sm"><spline>  PD: <?php echo $pdbroj; ?></spline></div>
        ...
        <div class="row">
          ...
          <div id=impd class="col-sm"><spline> Stan br: <?php echo $brojstana;?></spline></div>
          
        </div>
        <div class="row">
          <div  class="col-sm"><spline> Datum izdavanja računa: <?php 
          echo date("d/m/Y")
          ?></spline></div>
          <div id=impd class="col-sm"><spline>Stambeni prostor</spline></div>
        ...
        <div style="text-align: center; font-size:16px"><p><b>U slučaju reklamacije računa ili primjedbe možete dati putem mail-a:agencijapahulja@gmail.com ili na tel:068/070-090i tel:067/309-939 <br><center>Priloženi račun važi bez pečata</center><br><center>Agencija Pahulja <img id="ikonica"src="srce.svg"> </center></b></p>
